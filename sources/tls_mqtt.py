...
TCP_IP_ETH_OVERHEAD = 54
DEFAULT_OVERHEAD = TLS_RECORD_OVERHEAD + TCP_IP_ETH_OVERHEAD


class TlsMqttSource:
    def __init__(self, host: str, port: int = 8883,
                 topics: Sequence[str] = DEFAULT_TOPICS,
                 client_id: str = 'agente-8883',
        ...
        tls = {'ca_certs': ca_certs, 'certfile': certfile, 'keyfile': keyfile}
        if insecure:
            tls['cert_reqs'] = 0
